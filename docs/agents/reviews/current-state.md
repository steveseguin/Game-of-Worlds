...
| Music/timer | Multi-track lobby, launch, campaign, building, and battle playlists fade between tracks and skip failures. Campaign music keeps normal tempo until the final 20% of a turn (maximum 60-second urgency window), then ramps by at most 12%; delayed scheduler callbacks skip missed beats rather than bursting. |
