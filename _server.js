									...
									if ((s1+s2*3+s3*1+s4*2+s5*3+s6*2)*100<=resultp['crystal']){
										...
										for (var ii in resultss){
											...
											console.log('sectorfound');
												...
												client.query('UPDATE players'+connection.gameid+' SET crystal = crystal - '+(s1+s2*3+s3*1+s4*2+s5*3+s6*2)*100+' WHERE playerid = '+connection.name);
												client.query('UPDATE map'+connection.gameid+' SET totalship1 = totalship1 - '+s1+', totalship2 = totalship2 - '+s2+', totalship3 = totalship3 -  '+s3+', totalship4 = totalship4 - '+s4+', totalship5 = totalship5 - '+s5+', totalship6 = totalship6 - '+s6+' WHERE sectorid = '+fromHere);
                                                                                                offabsorb = (s1 + s2*2 + s3 +s4*2 + s5*3 +s6)*(resultp['tech5']*0.1 +1);
												defabsorb = (resultsx['totalship1'] + resultsx['totalship2']*2 + resultsx['totalship3'] + resultsx['totalship4']*2 + resultsx['totalship5']*3 + resultsx['totalship6'])*(resultdd['tech5']*0.1+1) + resultsx['groundturret'] + 1;
												i=0;
												battle='';
												while (i==0){
	
	                                                                                                offshield = (s1 + s2 + s4 + s5*2 + s6)/(s1+s2+s3+s4+s5+s6);
			                                                                                defshield = (resultsx['totalship1']+ resultsx['totalship2'] + resultsx['totalship4'] + resultsx['totalship5']*2 + resultsx['totalship6'])/(resultsx['totalship1']+resultsx['totalship2']+resultsx['totalship3']+resultsx['totalship4']+resultsx['totalship5']+resultsx['totalship6']+resultsx['groundturret']);
													battle+=":"+s1+":"+s2+":"+s3+":"+s4+":"+s5+":"+s6+":"+resultsx['totalship1']+":"+resultsx['totalship2']+":"+resultsx['totalship3']+":"+resultsx['totalship4']+":"+resultsx['totalship5']+":"+resultsx['totalship6']+":"+resultsx['groundturret']+":"+resultsx['orbitalturret'];
									                        	defattack = (resultsx['totalship1'] + resultsx['totalship2']*2 + resultsx['totalship4']*1 + resultsx['totalship5']*3)*(resultsdd['tech4']*0.1+1) + resultsx['orbitalturret'];
                                                                                                	offattack = (s1 + s2*2 + s4*1 + s5*3)*(resultp['tech4']*.1+1);
													...
													console.log("BATTLE STILL IN PROGRESS");
																		 ...
																		 resultsx['totalship5']=0;
																			...
																			client.query('UPDATE map'+connection.gameid+' SET totalship1 = '+s1+', totalship2 = '+s2+', totalship3 = '+s3+', totalship4 = '+s4+', totalship5 = '+s5+', totalship6 = '+s6+', ownerid = '+connection.name+', colonized = 0, groundturret = 0, orbitalturret = 0, academylvl = 0, shipyardlvl = 0, metallvl = 0, crystallvl = 0, totship1build = 0, totship2build = 0, totship3build = 0, totship4build = 0, totship5build = 0, totship6build = 0 WHERE sectorid = '+gotoHere);
