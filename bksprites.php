 	...
 	echo "
	   ...
	   <div id=\"techtab\"
		...
		onclick=\"
                        ...
                        document.getElementById('fleetdeets').style.display='none';
		...
		style=\"
			...
			overflow:hidden;
                	\"
		>
		<div style='margin:5px;'><b>Technology</b></div>
           </div>
  	   <div id=\"buildtab\"
		class=\"mainMenu\"
                onclick=\"
		...
		overflow:hidden;
                \" >
		<div style='margin:5px;'><b>Construction</b></div>
           </div>
	   <div id=\"fleettab\"
    	 	class=\"mainMenu\"
                onclick=\"
                        document.getElementById('fleetdeets').style.display='inline';
		...
		overflow:hidden;
                \" >
		<div style='margin:5px;'><b>Colonize</b></div>
	   </div>";
	   comtech();
	   combuild();
	   comfleet();
