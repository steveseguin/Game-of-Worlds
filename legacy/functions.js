...
function sendaamm(){
        var i;
        var secattk = document.getElementById('sectorofattack').innerHTML;
        ...
        for (y=3;y<=(arr.length-1);y+=3){
                if (parseInt(arr[y-1])==1){
                        outbound+=":"+arr[y-2]+":1:1"
                        sumofships+=2;
totalships++;
                }
                else if (parseInt(arr[y-1])==2){
                        outbound+=":"+arr[y-2]+":2:1"
                        sumofships+=3;
totalships++;             
   }
                else if (parseInt(arr[y-1])==4){
                        outbound+=":"+arr[y-2]+":4:1"
                        sumofships+=2;
totalships++;             
   }
                else if (parseInt(arr[y-1])==5){
                        outbound+=":"+arr[y-2]+":5:1"
                        sumofships+=3;
totalships++;             
   }
        }
        if (confirm('Are you sure you wish to send '+totalships+' ships to sector '+document.getElementById('sectorofattack').innerHTML+'?        It will cost you '+(sumofships*100)+' crystal.')){
                 websocket.send("//sendmmf:"+secattk+outbound);
...
function sendmmf(){
        var i;
	secattk = document.getElementById('sectorofattack').innerHTML;
	list2send=document.getElementById('sectorofattack').innerHTML;
	var totalships=0;
        for(i = document.getElementById('shipsFromNearBy').options.length-1;i>=0;i--){
